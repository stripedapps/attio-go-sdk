...
// checks if the V2MeetingsMeetingIdCallRecordingsPost400Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2MeetingsMeetingIdCallRecordingsPost400Response{}
...
func NewV2MeetingsMeetingIdCallRecordingsPost400Response(statusCode float32, type_ string, code string, message string) *V2MeetingsMeetingIdCallRecordingsPost400Response {
	this := V2MeetingsMeetingIdCallRecordingsPost400Response{}
...
func (o V2MeetingsMeetingIdCallRecordingsPost400Response) ToMap() (map[string]interface{}, error) {
...
func (o *V2MeetingsMeetingIdCallRecordingsPost400Response) UnmarshalJSON(data []byte) (err error) {
	...
	varV2MeetingsMeetingIdCallRecordingsPost400Response := _V2MeetingsMeetingIdCallRecordingsPost400Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV2MeetingsMeetingIdCallRecordingsPost400Response)

	if err != nil {
		return err
	}

	*o = V2MeetingsMeetingIdCallRecordingsPost400Response(varV2MeetingsMeetingIdCallRecordingsPost400Response)

	return err
}

type NullableV2MeetingsMeetingIdCallRecordingsPost400Response struct {
	value *V2MeetingsMeetingIdCallRecordingsPost400Response
	isSet bool
}

func (v NullableV2MeetingsMeetingIdCallRecordingsPost400Response) Get() *V2MeetingsMeetingIdCallRecordingsPost400Response {
	return v.value
}

func (v *NullableV2MeetingsMeetingIdCallRecordingsPost400Response) Set(val *V2MeetingsMeetingIdCallRecordingsPost400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableV2MeetingsMeetingIdCallRecordingsPost400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableV2MeetingsMeetingIdCallRecordingsPost400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2MeetingsMeetingIdCallRecordingsPost400Response(val *V2MeetingsMeetingIdCallRecordingsPost400Response) *NullableV2MeetingsMeetingIdCallRecordingsPost400Response {
	return &NullableV2MeetingsMeetingIdCallRecordingsPost400Response{value: val, isSet: true}
}

func (v NullableV2MeetingsMeetingIdCallRecordingsPost400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2MeetingsMeetingIdCallRecordingsPost400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
