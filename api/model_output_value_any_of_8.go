...
// checks if the OutputValueAnyOf8 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OutputValueAnyOf8{}

// OutputValueAnyOf8 struct for OutputValueAnyOf8
type OutputValueAnyOf8 struct {
...
type _OutputValueAnyOf8 OutputValueAnyOf8
...
func (o OutputValueAnyOf8) ToMap() (map[string]interface{}, error) {
...
func (o *OutputValueAnyOf8) UnmarshalJSON(data []byte) (err error) {
	...
	varOutputValueAnyOf8 := _OutputValueAnyOf8{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOutputValueAnyOf8)

	if err != nil {
		return err
	}

	*o = OutputValueAnyOf8(varOutputValueAnyOf8)

	return err
}

type NullableOutputValueAnyOf8 struct {
	value *OutputValueAnyOf8
	isSet bool
}

func (v NullableOutputValueAnyOf8) Get() *OutputValueAnyOf8 {
	return v.value
}

func (v *NullableOutputValueAnyOf8) Set(val *OutputValueAnyOf8) {
	v.value = val
	v.isSet = true
}

func (v NullableOutputValueAnyOf8) IsSet() bool {
	return v.isSet
}

func (v *NullableOutputValueAnyOf8) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOutputValueAnyOf8(val *OutputValueAnyOf8) *NullableOutputValueAnyOf8 {
	return &NullableOutputValueAnyOf8{value: val, isSet: true}
}

func (v NullableOutputValueAnyOf8) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOutputValueAnyOf8) UnmarshalJSON(src []byte) error {
	v.isSet = true
