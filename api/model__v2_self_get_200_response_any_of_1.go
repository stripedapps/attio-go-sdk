...
// checks if the V2SelfGet200ResponseAnyOf1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V2SelfGet200ResponseAnyOf1{}

// V2SelfGet200ResponseAnyOf1 struct for V2SelfGet200ResponseAnyOf1
type V2SelfGet200ResponseAnyOf1 struct {
...
type _V2SelfGet200ResponseAnyOf1 V2SelfGet200ResponseAnyOf1
...
func NewV2SelfGet200ResponseAnyOf1(active bool, scope string, clientId string, tokenType string, exp NullableFloat32, iat float32, sub string, aud string, iss string, workspaceId string, workspaceName string, workspaceSlug string, workspaceLogoUrl NullableString) *V2SelfGet200ResponseAnyOf1 {
...
// GetAuthorizedByWorkspaceMemberId returns the AuthorizedByWorkspaceMemberId field value if set, zero value otherwise.
func (o *V2SelfGet200ResponseAnyOf1) GetAuthorizedByWorkspaceMemberId() string {
	if o == nil || IsNil(o.AuthorizedByWorkspaceMemberId) {
		var ret string
		return ret
	}
...
// GetAuthorizedByWorkspaceMemberIdOk returns a tuple with the AuthorizedByWorkspaceMemberId field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// HasAuthorizedByWorkspaceMemberId returns a boolean if a field has been set.
func (o *V2SelfGet200ResponseAnyOf1) HasAuthorizedByWorkspaceMemberId() bool {
	if o != nil && !IsNil(o.AuthorizedByWorkspaceMemberId) {
		return true
	}
...
// SetAuthorizedByWorkspaceMemberId gets a reference to the given string and assigns it to the AuthorizedByWorkspaceMemberId field.
...
func (o V2SelfGet200ResponseAnyOf1) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AuthorizedByWorkspaceMemberId) {
...
func (o *V2SelfGet200ResponseAnyOf1) UnmarshalJSON(data []byte) (err error) {
	...
	varV2SelfGet200ResponseAnyOf1 := _V2SelfGet200ResponseAnyOf1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV2SelfGet200ResponseAnyOf1)

	if err != nil {
		return err
	}

	*o = V2SelfGet200ResponseAnyOf1(varV2SelfGet200ResponseAnyOf1)

	return err
}

type NullableV2SelfGet200ResponseAnyOf1 struct {
	value *V2SelfGet200ResponseAnyOf1
	isSet bool
}

func (v NullableV2SelfGet200ResponseAnyOf1) Get() *V2SelfGet200ResponseAnyOf1 {
	return v.value
}

func (v *NullableV2SelfGet200ResponseAnyOf1) Set(val *V2SelfGet200ResponseAnyOf1) {
	v.value = val
	v.isSet = true
}

func (v NullableV2SelfGet200ResponseAnyOf1) IsSet() bool {
	return v.isSet
}

func (v *NullableV2SelfGet200ResponseAnyOf1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV2SelfGet200ResponseAnyOf1(val *V2SelfGet200ResponseAnyOf1) *NullableV2SelfGet200ResponseAnyOf1 {
	return &NullableV2SelfGet200ResponseAnyOf1{value: val, isSet: true}
}

func (v NullableV2SelfGet200ResponseAnyOf1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV2SelfGet200ResponseAnyOf1) UnmarshalJSON(src []byte) error {
	v.isSet = true
