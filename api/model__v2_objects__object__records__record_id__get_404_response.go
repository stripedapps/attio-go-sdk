...
type V2ObjectsObjectRecordsRecordIdGet404Response struct {
	...
	Code V2ObjectsObjectRecordsRecordIdGet404ResponseCode `json:"code"`
...
func NewV2ObjectsObjectRecordsRecordIdGet404Response(statusCode float32, type_ string, code V2ObjectsObjectRecordsRecordIdGet404ResponseCode, message string) *V2ObjectsObjectRecordsRecordIdGet404Response {
...
func (o *V2ObjectsObjectRecordsRecordIdGet404Response) GetCode() V2ObjectsObjectRecordsRecordIdGet404ResponseCode {
	if o == nil {
		var ret V2ObjectsObjectRecordsRecordIdGet404ResponseCode
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *V2ObjectsObjectRecordsRecordIdGet404Response) GetCodeOk() (*V2ObjectsObjectRecordsRecordIdGet404ResponseCode, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Code, true
...
func (o *V2ObjectsObjectRecordsRecordIdGet404Response) SetCode(v V2ObjectsObjectRecordsRecordIdGet404ResponseCode) {
	o.Code = v
}
